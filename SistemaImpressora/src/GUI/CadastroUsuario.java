...
public class CadastroUsuario extends JFrame implements ActionListener, KeyListener {
	...
	public CadastroUsuario(LoginScreen parent) {
		super();
		initializeFrame();
		initializeGUI();
		addComponents();
		...
		comboSexo.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if ("Outro".equals(comboSexo.getSelectedItem())) {
					...
					String novoSexo = JOptionPane.showInputDialog(CadastroUsuario.this, "Digite o novo sexo:");
