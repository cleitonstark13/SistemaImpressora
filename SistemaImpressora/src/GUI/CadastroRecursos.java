...
public class CadastroRecursos extends JDialog implements ActionListener, KeyListener {
	private JComboBox<String> comboModelo;
	private JTextField JTToner, JTCilindro, JTCompra;
	private JButton salvarButton, cancelarButton;
	private static final long serialVersionUID = 1L;

	public CadastroRecursos(Gui parent) {
		...
		JLabel tonerLabel = new JLabel("Quantidade de toners:");
		JTToner = new JTextField(10);

		JLabel cilindroLabel = new JLabel("Quantidade de cilindros:");
		JTCilindro = new JTextField(10);
		
		JLabel compraLabel = new JLabel("Data da Compra:");
		JTCompra = new JTextField(10);
		...
		setPreferredSize(new Dimension(300, 220)); // Define o tamanho preferido para ser quadrado
		pack();
